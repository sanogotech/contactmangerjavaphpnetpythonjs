...
import com.mobile.rodolpheagnero.contactmanager.LoginActivity;
...
public class UserSessionManager {
    ...
    // numberphone getway (make variable public to access from outside)
    ...
    public void createUserLoginSession(String username, String password, String nom,
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        //
        user.put(KEY_PASSWORD, pref.getString(KEY_USERNAME, null));
